    ...
    <Shell>
      <article className="mx-auto max-w-5xl space-y-8 px-4 py-10">
        ...
        <section className="rounded-lg border border-border p-5">
          ...
          <div className="mt-3 flex flex-wrap gap-5 text-sm text-primary"><Link to="/research-checklist">Research checklist</Link><Link to="/methodology">Methodology</Link><Link to="/contact">Contact the team</Link></div>
        </section>
      </article>
    </Shell>
  );
